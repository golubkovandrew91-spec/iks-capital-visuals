      ...
      <section id="about" className="py-20 bg-gradient-to-br from-background to-muted/30">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto text-center mb-20 animate-fade-in">
            <h2 className="text-4xl font-bold mb-8 text-gradient-primary">Как мы появились</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto mb-20">
            <Card className="card-elevated text-center">
              <CardContent className="pt-8">
                ...
                <h3 className="text-2xl font-bold mb-2">Трейдинг</h3>
                <div className="text-4xl font-bold text-gradient-primary mb-2">
                  <AnimatedCounter end={50} suffix="%" />
                </div>
                <p className="text-muted-foreground">доходности к депозиту</p>
              </CardContent>
            </Card>
            ...
            <Card className="card-elevated text-center">
              <CardContent className="pt-8">
                ...
                <h3 className="text-2xl font-bold mb-2">Портфельное управление</h3>
                <div className="text-4xl font-bold text-gradient-primary mb-2">
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <Card className="card-elevated">
              <CardHeader>
                ...
                <CardTitle>Видение (3–5 лет)</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
            ...
            <Card className="card-elevated">
              <CardHeader>
                ...
                <CardTitle>Обязательство бренда</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
          ...
          <div className="max-w-4xl mx-auto text-center mt-20">
            <h2 className="text-3xl font-bold mb-6 text-gradient-primary">Куда направляемся</h2>
            <p className="text-lg text-foreground leading-relaxed">
      ...
      <section className="py-20 bg-gradient-to-br from-muted/30 to-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-6 text-gradient-primary">Основные направления</h2>
          ...
          <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <Card className="card-elevated group">
              <CardHeader>
                ...
                <CardTitle className="text-xl">Портфельное управление</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="card-elevated group">
              <CardHeader>
                ...
                <CardTitle className="text-xl">Трейдинг</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-6">
            ...
            <Card className="card-elevated group">
              <CardHeader>
                ...
                <CardTitle className="text-xl">Инновационные направления</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground mb-6">
