  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-24 pb-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
            <h1 className="text-3xl sm:text-5xl md:text-6xl font-bold text-gradient-primary">
      ...
      <section className="py-20 bg-gradient-to-br from-background to-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-2xl sm:text-4xl font-bold mb-6 sm:mb-8 text-gradient-primary text-center">
      ...
      <section className="py-20 bg-gradient-to-br from-muted/30 to-background">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl sm:text-4xl font-bold mb-12 sm:mb-16 text-gradient-primary text-center">
              Ключевые особенности и возможности
            </h2>
            
            <div className="grid md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-6 sm:gap-8">
              <Card className="card-elevated text-center group">
                <CardContent className="pt-6 sm:pt-8">
                  <Shield className="h-8 w-8 sm:h-12 sm:w-12 text-primary mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform" />
                  <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">Свободное управление</h3>
              ...
              <Card className="card-elevated text-center group">
                <CardContent className="pt-6 sm:pt-8">
                  <Lock className="h-8 w-8 sm:h-12 sm:w-12 text-primary mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform" />
                  <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">Максимальная защита</h3>
                  <p className="text-muted-foreground text-xs sm:text-sm">
              ...
              <Card className="card-elevated text-center group">
                <CardContent className="pt-6 sm:pt-8">
                  <DollarSign className="h-8 w-8 sm:h-12 sm:w-12 text-primary mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform" />
                  <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">Полный контроль</h3>
                  <p className="text-muted-foreground text-xs sm:text-sm">
              ...
              <Card className="card-elevated text-center group">
                <CardContent className="pt-6 sm:pt-8">
                  <Coins className="h-8 w-8 sm:h-12 sm:w-12 text-primary mx-auto mb-3 sm:mb-4 group-hover:scale-110 transition-transform" />
                  <h3 className="text-base sm:text-lg font-semibold mb-2 sm:mb-3">Дополнительный доход</h3>
                  <p className="text-muted-foreground text-xs sm:text-sm">
      ...
      <section className="py-20 bg-gradient-to-br from-muted/30 to-background">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-2xl sm:text-4xl font-bold mb-4 sm:mb-8 text-gradient-primary text-center">
              Методы приобретения активов
            </h2>
            <p className="text-lg sm:text-xl text-muted-foreground text-center mb-12 sm:mb-16">
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 mb-8 sm:mb-12">
              <Card className="card-elevated">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg sm:text-xl">Покупка по ключевым ценовым уровням</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="card-elevated">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg sm:text-xl">Стратегия усреднения стоимости (DCA)</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-sm sm:text-base mb-4 sm:mb-6">
            ...
            <Card className="card-elevated">
              <CardContent className="pt-6 sm:pt-8">
                <p className="text-foreground text-center leading-relaxed text-sm sm:text-base">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12">
              <Card className="card-elevated">
                <CardHeader>
                  <Lock className="h-6 w-6 sm:h-8 sm:w-8 text-primary mb-2" />
                  <CardTitle className="text-lg sm:text-xl">Хранение на собственном кошельке инвестора</CardTitle>
                  <p className="text-xs sm:text-sm text-primary font-medium">Максимальная защита и полный контроль</p>
                </CardHeader>
                <CardContent>
                  ...
                  <div>
                    <h4 className="font-semibold text-primary mb-2 sm:mb-3">Преимущества:</h4>
                    <ul className="text-xs sm:text-sm text-muted-foreground space-y-2">
              ...
              <Card className="card-elevated">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg sm:text-xl">Управление активами командой IKS Capital для увеличения доходности</CardTitle>
                  <p className="text-xs sm:text-sm text-primary font-medium">Активное увеличение прибыли через DeFi</p>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-sm sm:text-base mb-4 sm:mb-6 leading-relaxed">
                  ...
                  <div>
                    <h4 className="font-semibold text-primary mb-2 sm:mb-3">Преимущества активного управления:</h4>
                    <ul className="text-xs sm:text-sm text-muted-foreground space-y-2">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-8 sm:mb-12">
              <Card className="card-elevated">
                <CardContent className="pt-6 sm:pt-8">
                  <ul className="text-foreground space-y-3 sm:space-y-4 max-w-4xl mx-auto">
                    <li className="flex items-start">
                      <span className="w-2 h-2 sm:w-3 sm:h-3 bg-primary rounded-full mt-2 mr-3 sm:mr-4 flex-shrink-0"></span>
                      <span className="text-sm sm:text-base">При размещении активов в DeFi-инструментах инвестор получает вознаграждение в виде базового актива или токенов наград</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 sm:w-3 sm:h-3 bg-primary rounded-full mt-2 mr-3 sm:mr-4 flex-shrink-0"></span>
                      <span className="text-sm sm:text-base">Это означает, что со временем увеличивается количество монет на балансе инвестора</span>
                    </li>
                    <li className="flex items-start">
                      <span className="w-2 h-2 sm:w-3 sm:h-3 bg-primary rounded-full mt-2 mr-3 sm:mr-4 flex-shrink-0"></span>
                      <span className="text-sm sm:text-base">Когда рынок переходит в фазу роста, инвестор владеет уже большим объёмом токенов, чем было куплено изначально, увеличивая итоговую доходность</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
                        ...
                        <h3 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-gradient-primary text-center">
                          Основные DeFi-инструменты, используемые командой IKS Capital
                        </h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              <Card className="card-elevated">
                <CardHeader>
                  <Coins className="h-6 w-6 sm:h-8 sm:w-8 text-primary mb-2" />
                  <CardTitle className="text-base sm:text-lg">Ликвидный стейкинг — 2,7–8% годовых</CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <h4 className="font-semibold text-primary mb-2 text-sm">Механизм работы:</h4>
              ...
              <Card className="card-elevated">
                <CardHeader>
                  <TrendingUp className="h-6 w-6 sm:h-8 sm:w-8 text-primary mb-2" />
                  <CardTitle className="text-base sm:text-lg">Пулы ликвидности — 4–30% годовых</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-xs sm:text-sm mb-3 sm:mb-4">
                    Предоставление пары токенов в пулы на децентрализованных биржах в зависимости от пула и протокола.
                  </p>
                  <h4 className="font-semibold text-primary mb-2 text-sm">Источники дохода:</h4>
                  <ul className="text-xs text-muted-foreground space-y-1">
              ...
              <Card className="card-elevated">
                <CardHeader>
                  ...
                  <CardTitle className="text-base sm:text-lg">Лендинг — 4–6% годовых</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="text-muted-foreground text-xs sm:text-sm mb-3 sm:mb-4">
                    Размещение криптоактивов на платформах для предоставления займов под процент.
                  </p>
                  <h4 className="font-semibold text-primary mb-2 text-sm">Характеристики:</h4>
                  <ul className="text-xs text-muted-foreground space-y-1">
      ...
      <section className="py-20 bg-gradient-to-br from-background to-muted/30">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <Card className="card-elevated">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl">Базовый сценарий</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground text-sm sm:text-base mb-4 sm:mb-6">
                ...
                <h4 className="font-semibold text-primary mb-3 sm:mb-4 text-sm sm:text-base">При использовании DeFi-стратегий:</h4>
                <ol className="text-muted-foreground space-y-2 mb-4 sm:mb-6 text-xs sm:text-sm">
                ...
                <div className="bg-primary/10 p-4 sm:p-6 rounded-lg">
                  <h4 className="font-semibold text-primary mb-3 sm:mb-4 text-sm sm:text-base">Итоговый результат:</h4>
                  <p className="text-foreground mb-3 sm:mb-4 text-xs sm:text-sm">
      ...
      <section className="py-20 bg-gradient-to-br from-muted/30 to-background">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            ...
            <Card className="card-elevated">
              <CardHeader>
                <CardTitle className="text-lg sm:text-xl">Поэтапная покупка активов</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground text-sm sm:text-base mb-4 sm:mb-6 leading-relaxed">
                ...
                <h4 className="font-semibold text-primary mb-3 sm:mb-4 text-sm sm:text-base">Временное размещение средств:</h4>
                <ul className="text-muted-foreground space-y-2 mb-4 sm:mb-6 text-xs sm:text-sm">
      ...
      <section className="py-16 sm:py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button
            variant="glass"
            size="lg"
            className="text-primary hover:text-primary bg-white/20 hover:bg-white/30 text-sm sm:text-base"
            asChild
          >
            <Link to="/#contact">
